...
export default function ElectricianDemo() {
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0a", color: "#e8eaf0" }}>
      ...
      {/* ── Services ─────────────────────────────────────────────── */}
      <section className="elec-section" style={{ padding: "80px 24px", background: "#08090c", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 600, height: 600, borderRadius: "50%", background: "radial-gradient(circle, rgba(212,160,43,0.06) 0%, transparent 70%)", pointerEvents: "none" }} />
        <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <ScrollReveal>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", color: "#D4A02B", marginBottom: 12 }}>What We Do</div>
              <h2 style={{
              ...
              <p style={{ color: "#b0b4c8", fontSize: 16 }}>
      ...
      <section className="elec-section" style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <ScrollReveal>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", color: "#D4A02B", marginBottom: 12 }}>The Difference</div>
              <h2 style={{
                fontFamily: "'Bebas Neue', sans-serif", fontSize: 48,
                letterSpacing: 2, margin: "0 0 12px",
              }}>
              ...
              <p style={{ color: "#b0b4c8", fontSize: 16 }}>What sets us apart from every other electrician in Rochester Hills</p>
            </div>
          </ScrollReveal>
          <div className="elec-why-grid" style={{
            ...
            {[
              ...
              <ScrollReveal key={c.title} delay={i * 120}>
                <GlowCard color="#D4A02B" style={{ textAlign: "center" }}>
                  <div style={{
                    width: 56, height: 56, borderRadius: "50%",
                    background: "linear-gradient(135deg, rgba(212,160,43,0.15), rgba(212,160,43,0.05))",
                    border: "1px solid rgba(212,160,43,0.2)",
                    display: "flex", alignItems: "center", justifyContent: "center",
                    margin: "0 auto 18px",
                  }}>
                    <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 22, color: "#D4A02B" }}>{c.num}</div>
                  </div>
                  <h3 style={{
        ...
        <div style={{ padding: "80px 24px 80px", maxWidth: 1100, margin: "0 auto" }}>
          <ScrollReveal>
            <div style={{ textAlign: "center", marginBottom: 48 }}>
              <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", color: "#D4A02B", marginBottom: 12 }}>Reviews</div>
              <h2 style={{
                fontFamily: "'Bebas Neue', sans-serif", fontSize: 48,
                letterSpacing: 2, margin: "0 0 12px",
              }}>
              ...
              <p style={{ color: "#b0b4c8", fontSize: 16 }}>Real reviews from homeowners in the Rochester Hills area</p>
            </div>
          </ScrollReveal>
        </div>
        <ScrollReveal>
      ...
      {/* ── Service Area ─────────────────────────────────────────── */}
      <section className="elec-section" style={{ padding: "80px 24px", position: "relative" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          <ScrollReveal>
            <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", color: "#D4A02B", marginBottom: 12 }}>Coverage</div>
            <h2 style={{
              fontFamily: "'Bebas Neue', sans-serif", fontSize: 48,
              letterSpacing: 2, margin: "0 0 12px",
            }}>
            ...
            <p style={{
              color: "#b0b4c8", fontSize: 16, marginBottom: 32,
            }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 14 }}>
              {[
                ...
                <span key={city} style={{
                  ...
                  border: "1px solid rgba(212,160,43,0.2)",
                  color: "#D4A02B", fontSize: 15, fontWeight: 600,
      ...
      <section id="estimate" className="elec-section" style={{
        ...
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, rgba(212,160,43,0.15) 0%, rgba(212,160,43,0.03) 50%, rgba(212,160,43,0.10) 100%)" }} />
        <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 500, height: 500, borderRadius: "50%", background: "radial-gradient(circle, rgba(212,160,43,0.12) 0%, transparent 70%)", pointerEvents: "none" }} />
        <div style={{ maxWidth: 700, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <ScrollReveal>
            <h2 style={{
              fontFamily: "'Bebas Neue', sans-serif", fontSize: 56,
              letterSpacing: 3, margin: "0 0 20px",
            }}>
              Power Your Home <span style={{ color: "#D4A02B" }}>With Confidence</span>
            </h2>
            <p style={{
              color: "#b0b4c8", fontSize: 18, lineHeight: 1.7, maxWidth: 550, margin: "0 auto 40px",
            }}>
            ...
            <div style={{
              ...
              <a href="tel:2485550361" style={{
                background: "#D4A02B", color: "#0a0a0a", padding: "18px 44px",
                borderRadius: 8, fontSize: 20, fontWeight: 700, textDecoration: "none",
              ...
              <a href="#estimate" style={{
                background: "transparent", color: "#e8eaf0",
                border: "1px solid rgba(255,255,255,0.2)",
                padding: "18px 44px", borderRadius: 8, fontSize: 18,
                fontWeight: 600, textDecoration: "none",
              }}>
