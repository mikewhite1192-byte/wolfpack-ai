...
export default function BookingPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#ffffff", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <style>{`
        .bk-card { width: 520px; max-width: 100%; background: #fff; border-radius: 20px; box-shadow: 0 4px 40px rgba(0,0,0,0.08); overflow: hidden; }
        .bk-header { padding: 32px 36px 24px; text-align: center; border-bottom: 1px solid #f0f0f0; }
        .bk-title { font-size: 22px; font-weight: 800; color: #1a1a1a; letter-spacing: -0.3px; }
        .bk-subtitle { font-size: 14px; color: #888; margin-top: 6px; }
        .bk-body { padding: 28px 36px 32px; }
        .bk-label { font-size: 14px; font-weight: 600; color: #333; margin-bottom: 16px; }
        .bk-back { background: none; border: none; color: #888; font-size: 13px; cursor: pointer; margin-bottom: 16px; padding: 0; }
        .bk-back:hover { color: #E86A2A; }

        .bk-dates { display: flex; gap: 8px; flex-wrap: wrap; }
        .bk-date { width: 72px; padding: 14px 0; border-radius: 12px; border: 2px solid #f0f0f0; background: #fff; cursor: pointer; text-align: center; transition: all 0.15s; }
        .bk-date:hover { border-color: #E86A2A; }
        .bk-date.selected { border-color: #E86A2A; background: #E86A2A; }
        .bk-date-day { font-size: 11px; color: #999; font-weight: 500; }
        .bk-date.selected .bk-date-day { color: rgba(255,255,255,0.8); }
        .bk-date-num { font-size: 22px; font-weight: 800; color: #1a1a1a; margin: 2px 0; }
        .bk-date.selected .bk-date-num { color: #fff; }
        .bk-date-month { font-size: 10px; color: #bbb; font-weight: 500; }
        ...
        .bk-time { padding: 12px; border-radius: 10px; border: 2px solid #f0f0f0; background: #fff; color: #333; font-size: 14px; font-weight: 600; cursor: pointer; text-align: center; transition: all 0.15s; }
        .bk-time:hover { border-color: #E86A2A; color: #E86A2A; }

        .bk-selected-badge { background: #FFF5F0; border: 1px solid #FFE0D0; border-radius: 10px; padding: 12px 16px; margin-bottom: 20px; font-size: 14px; color: #E86A2A; font-weight: 600; text-align: center; }

        .bk-field { margin-bottom: 14px; }
        .bk-field-label { font-size: 12px; font-weight: 600; color: #888; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px; }
        .bk-input { width: 100%; padding: 12px 16px; border: 2px solid #f0f0f0; border-radius: 10px; font-size: 14px; color: #1a1a1a; outline: none; box-sizing: border-box; font-family: inherit; transition: border 0.15s; }
        ...
        .bk-submit:hover { background: #d45a1a; }
        .bk-submit:disabled { opacity: 0.5; cursor: default; }

        .bk-done { text-align: center; padding: 20px 0; }
        .bk-done-icon { width: 64px; height: 64px; border-radius: 50%; background: #F0FFF0; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; font-size: 28px; }
        .bk-done-title { font-size: 20px; font-weight: 800; color: #1a1a1a; margin-bottom: 8px; }
        .bk-done-date { font-size: 15px; color: #666; margin-bottom: 4px; }
        .bk-done-time { font-size: 18px; font-weight: 700; color: #E86A2A; margin-bottom: 16px; }
        .bk-done-text { font-size: 14px; color: #999; line-height: 1.6; }

        .bk-empty { text-align: center; padding: 30px; color: #999; font-size: 14px; }
        ...
        .bk-step-dot { width: 8px; height: 8px; border-radius: 50%; background: #eee; }
      ...
      <div className="bk-card">
        <div className="bk-header">
          ...
          <div className="bk-subtitle">30 minute consultation</div>
        </div>
            ...
            <div>
              ...
              <div className="bk-dates">
                {weekdays.map(d => (
                  <div
                    key={d.value}
                    className={`bk-date ${selectedDate === d.value ? "selected" : ""}`}
            ...
            <div>
              ...
              {loading ? (
                ...
                <div className="bk-times">
                  {slots.map(s => (
                    <div key={s.start} className="bk-time" onClick={() => selectSlot(s)}>
                      {s.display}
                    </div>
                  ))}
                </div>
