  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh", fontFamily: "'Inter', system-ui, sans-serif", color: T.text }}>
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "80px 24px" }}>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, color: T.orange, marginTop: 36, marginBottom: 12 }}>5. Data Retention</h2>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, color: T.orange, marginTop: 36, marginBottom: 12 }}>6. Data Security</h2>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, color: T.orange, marginTop: 36, marginBottom: 12 }}>7. Third-Party Services</h2>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, color: T.orange, marginTop: 36, marginBottom: 12 }}>8. Your Rights</h2>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, color: T.orange, marginTop: 36, marginBottom: 12 }}>9. Children</h2>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, color: T.orange, marginTop: 36, marginBottom: 12 }}>10. Changes to This Policy</h2>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, color: T.orange, marginTop: 36, marginBottom: 12 }}>11. Contact</h2>
